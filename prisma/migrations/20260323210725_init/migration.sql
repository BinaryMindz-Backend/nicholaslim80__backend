...
-- CreateEnum
CREATE TYPE "IncentiveRewardType" AS ENUM ('FIXED', 'PERCENTAGE', 'POINTS');

-- CreateEnum
CREATE TYPE "ClaimType" AS ENUM ('AUTO', 'MANUAL');

-- CreateEnum
CREATE TYPE "Metric" AS ENUM ('COMPLETED_DELIVERIES', 'TOTAL_EARNINGS', 'ONLINE_HOURS', 'ACCEPTED_ORDERS', 'ACCEPTANCE_RATE', 'CONSECUTIVE_TRIPS', 'REFERRAL_COUNT');

-- CreateEnum
CREATE TYPE "Operator" AS ENUM ('GTE', 'LTE', 'EQ', 'GT', 'LT');

-- CreateEnum
CREATE TYPE "DriverType" AS ENUM ('BIKE', 'CAR', 'CYCLE');
...
CREATE TABLE "delivery_types" (
    ...
    "name" TEXT NOT NULL,
    "description" TEXT,
    "price_multiplier" DECIMAL(6,3) NOT NULL,
    "collection_time" INTEGER NOT NULL,
    "collection_unit" "TimeUnit" NOT NULL DEFAULT 'MINUTES',
...
CREATE TABLE "vehicle_types" (
    ...
    "dimension_width" DECIMAL(12,2),
    "dimension_height" DECIMAL(12,2),
    "dimension_length" DECIMAL(12,2),
    "max_load" DECIMAL(12,2),
    "base_distance" DECIMAL(12,2),
    "isActive" BOOLEAN NOT NULL DEFAULT true,
    "admin_id" INTEGER NOT NULL,
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP(3) NOT NULL,
...
-- CreateIndex
CREATE INDEX "vehicle_types_vehicle_type_idx" ON "vehicle_types"("vehicle_type");
