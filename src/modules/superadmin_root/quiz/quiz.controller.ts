...
export class QuizController {
  ...
  @RequirePermission(Module.QUIZZES, Permission.CREATE)
  @ApiBearerAuth()
  ...
  @Auth()
  // @Roles(UserRole.SUPER_ADMIN)
  @RequirePermission(Module.QUIZZES, Permission.READ)
  @ApiBearerAuth()
  ...
  @Auth()
  // @Roles(UserRole.SUPER_ADMIN)
  @RequirePermission(Module.QUIZZES, Permission.GET_ONE)
  @ApiBearerAuth()
  ...
  @Auth()
  // @Roles(UserRole.SUPER_ADMIN)
  @RequirePermission(Module.QUIZZES, Permission.UPDATE)
  @ApiBearerAuth()
  ...
  @Auth()
  // @Roles(UserRole.SUPER_ADMIN)
  @RequirePermission(Module.QUIZZES, Permission.DELETE)
  @ApiBearerAuth()
